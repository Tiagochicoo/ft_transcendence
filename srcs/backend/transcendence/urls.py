...
from .views.tournament import TournamentCreate, TournamentMatchesCreate, TournamentTournamentUserDetails, UserTournamentDetails, TournamentUserAccept, TournamentUserRefuse, TournamentDetail, TournamentUpdate
...
urlpatterns = [
    ...
    path('tournaments/<int:tournamentId>/matches/', TournamentMatchesCreate.as_view(), name='tournament_matches_create'),
