...
from .views.tournament import TournamentCreate, TournamentTournamentUserDetails, UserTournamentDetails, TournamentUserAccept, TournamentUserRefuse, TournamentDetail, TournamentUpdate
