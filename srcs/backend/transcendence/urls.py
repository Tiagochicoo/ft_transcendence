...
from .views.tournament import TournamentCreate, TournamentMatches, TournamentTournamentUserDetails, UserTournamentDetails, TournamentUserAccept, TournamentUserRefuse, TournamentDetail, TournamentUpdate
